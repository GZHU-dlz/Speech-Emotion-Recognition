import train_ser_emodb
from train_ser_emodb import parse_arguments
import sys
import pickle
import os
import time
...
features_file = '../EmoDB.pkl'

#  leave-one-speaker-out
val_id = ['12F','14F','09F','13F','11F','15F','10F','16F','03M','08F']
test_id = ['12F','14F','09F','13F','11F','15F','10F','16F','03M','08F']
...
for repeat in range(repeat_kfold):
    ...
    for v_id, t_id in list(zip(val_id, test_id)):
        ...
        stat = train_ser_emodb.main(parse_arguments(sys.argv[1:]))
...
print("AVERAGE:", total_best_epoch / n_total, total_epoch / n_total, total_loss / n_total, total_wa / n_total,
      total_ua / n_total)
